...
export type GetContentQuery = {
  ...
  fields:
    ...
    | 'id,createdAt,updatedAt,publishedAt,revisedAt,title,category,mainVisual,description';
  // fields?: string;
  // depth?: number;
};
...
export type GetPagesItemQuery = {
  // 今回はリストもすべて受信
  fields: 'id,createdAt,updatedAt,publishedAt,revisedAt,title,content,category,mainVisual';
} & GetQuery;
